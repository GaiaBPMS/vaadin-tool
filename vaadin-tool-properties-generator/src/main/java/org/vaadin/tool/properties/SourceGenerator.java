...
import org.vaadin.tool.properties.SourceGenerator.ComponentModel.ComponentProperty;
...
class SourceGenerator {
						...
						if (setterFound && !excludedProperties.contains(pid)) {
							...
							if (primitiveWrapperClasses.contains(type)
								...
								if (type == String.class) {
									defaultValue = "org.gaia.cdi.properties.ComponentConfigurator.IGNORED_STRING";
								}
	...
	private static Collection<? extends ComponentProperty> getCustomProperties(
		...
		result.add(new ComponentProperty("String", "width",
				"org.gaia.cdi.properties.ComponentConfigurator.IGNORED_STRING"));
	...
	private static String toProducer(Set<ComponentModel> componentModels) {
		...
		sb.append("package org.gaia.cdi.properties.producer;\n");
		sb.append("import org.gaia.cdi.properties.ComponentConfigurator;\n");
		sb.append("import org.gaia.cdi.properties.annotation.*;\n");
	...
	static class ComponentModel {
		...
		public String toAnnotation() {
			StringBuilder sb = new StringBuilder();
			sb.append("package org.gaia.cdi.properties.annotation;\n");
			sb.append("import javax.inject.*;\n");
